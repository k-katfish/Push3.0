...
namespace ScanHostLib
{
    public class OSInfo
    {
        ...
        public OSInfo() { }
        public OSInfo(string ComputerName, string Caption, string Version, DateTime LocalDateTime, DateTime LastBootTime, TimeSpan Uptime, DateTime InstallDate, string RegisteredUser, string Organization, string AvailableRAM)
        {
            ...
            OSAvailableRAM   = AvailableRAM;
        }

        public OSInfo(string ComputerName, string Caption, string Version, DateTime LocalDateTime, DateTime LastBootTime, DateTime InstallDate, string RegisteredUser, string Organization, string AvailableRAM)
        {
            OSComputerName = ComputerName;
            OSCaption = Caption;
            OSVersion = Version;
            OSLocalDateTime = LocalDateTime;
            OSLastBootTime = LastBootTime;
            OSUptime = LocalDateTime - LastBootTime;
            OSInstallDate = InstallDate;
            OSRegisteredUser = RegisteredUser;
            OSOrganization = Organization;
            OSAvailableRAM = AvailableRAM;
...
//            CimSession mySession = CimSession.Create("cs");
        ...
        public static OSInfo GetOSInfo(string? ComputerName)
        {
            ...
            os.LastBootTime = DateTime.Parse(cimInstance.CimInstanceProperties["LastBootTime"].Value.ToString());
            os.Uptime = DateTime.Parse(cimInstance.CimInstanceProperties["LocalDateTime"].Value.ToString()) - DateTime.Parse(cimInstance.CimInstanceProperties["LastBootTime"].Value.ToString());
